...
import type { FetchMatchVoiceActivityPayload } from "./renderer-process/match/fetch-match-voice-activity-handler";
import type { VoiceActivity } from "csdm/common/types/voice-activity";
import { fetchMatchVoiceActivityHandler } from "./renderer-process/match/fetch-match-voice-activity-handler";
...
import {
	deleteDemosHandler,
	type DeleteDemosResultPayload,
} from "./renderer-process/demo/delete-demos-handler";
...
} from "./renderer-process/player/fetch-player-handler";
...
import type {
	...
	PlayerHeatmapFilter,
	TeamHeatmapFilter,
} from "csdm/common/types/heatmap-filters";
...
import {
	searchHandler,
	type SearchPayload,
} from "./renderer-process/search/search-handler";
...
import type {
	CounterStrikeErrorPayload,
	WatchDemoErrorPayload,
} from "csdm/server/counter-strike";
import {
	watchPlayerRoundsHandler,
	type WatchPlayerRoundsPayload,
} from "./renderer-process/counter-strike/watch-player-rounds-handler";
import {
	updateRoundTagsHandler,
	type UpdateRoundTagsPayload,
} from "./renderer-process/tags/update-round-tags-handler";
...
import type {
	AddVideoPayload,
	WatchVideoSequencesPayload,
} from "csdm/common/types/video";
import {
...
import type {
	CameraPayload,
	UpdateCameraPayload,
} from "./renderer-process/cameras/camera-payload";
...
export interface RendererMessageHandlers {
	[RendererClientMessageName.InitializeApplication]: Handler<
		void,
		InitializeApplicationSuccessPayload
	>;
	...
	[RendererClientMessageName.FetchMatchesTable]: Handler<
		FetchMatchesTablePayload,
		MatchTable[]
	>;
	[RendererClientMessageName.FetchMatchByChecksum]: Handler<string, Match>;
	[RendererClientMessageName.FetchMatchHeatmapPoints]: Handler<
		MatchHeatmapFilter,
		Point[]
	>;
	[RendererClientMessageName.FetchTeamHeatmapPoints]: Handler<
		TeamHeatmapFilter,
		Point[]
	>;
	[RendererClientMessageName.FetchPlayerHeatmapPoints]: Handler<
		PlayerHeatmapFilter,
		Point[]
	>;
	[RendererClientMessageName.Fetch2DViewerData]: Handler<
		Fetch2dViewerDataPayload,
		Fetch2dViewerDataSuccessPayload
	>;
	[RendererClientMessageName.FetchMatchVoiceActivity]: Handler<
		FetchMatchVoiceActivityPayload,
		VoiceActivity[]
	>;
	...
	[RendererClientMessageName.InitializeVideo]: Handler<
		InitializeVideoPayload,
		InitializeVideoSuccessPayload
	>;
	[RendererClientMessageName.FetchDemosTable]: Handler<
		DemosTableFilter,
		Demo[]
	>;
	...
	[RendererClientMessageName.FetchPlayersTable]: Handler<
		PlayersTableFilter,
		PlayerTable[]
	>;
	[RendererClientMessageName.FetchTeamsTable]: Handler<
		TeamsTableFilter,
		TeamTable[]
	>;
	...
	[RendererClientMessageName.DeleteDemos]: Handler<
		Demo[],
		DeleteDemosResultPayload
	>;
	...
	>;
	[RendererClientMessageName.UpdateSteamAccountName]: Handler<
		UpdateSteamAccountNamePayload,
		string
	>;
	...
	[RendererClientMessageName.AddIgnoredSteamAccount]: Handler<
		string,
		IgnoredSteamAccount
	>;
	...
	[RendererClientMessageName.UpdateCamera]: Handler<
		UpdateCameraPayload,
		Camera
	>;
	...
	[RendererClientMessageName.ConnectDatabase]: Handler<
		DatabaseSettings | undefined,
		ConnectDatabaseError | undefined
	>;
	...
	[RendererClientMessageName.EnableHlaeCustomLocation]: Handler<
		string,
		HlaeVersionChangedPayload
	>;
	[RendererClientMessageName.DisableHlaeCustomLocation]: Handler<
		boolean,
		HlaeVersionChangedPayload
	>;
	...
	[RendererClientMessageName.EnableFfmpegCustomLocation]: Handler<
		string,
		FfmpegVersionChangedPayload
	>;
	[RendererClientMessageName.DisableFfmpegCustomLocation]: Handler<
		boolean,
		FfmpegVersionChangedPayload
	>;
	[RendererClientMessageName.RemoveVideosFromQueue]: Handler<string[]>;
	[RendererClientMessageName.FetchMatchFlashbangMatrixRows]: Handler<
		string,
		FlashbangMatrixRow[]
	>;
	[RendererClientMessageName.FetchMatchDuelsMatrixRows]: Handler<
		string,
		DuelMatrixRow[]
	>;
	[RendererClientMessageName.FetchMatchGrenadesThrow]: Handler<
		string,
		GrenadeThrow[]
	>;
	[RendererClientMessageName.WatchDemo]: Handler<
		WatchDemoPayload,
	...
	>;
	[RendererClientMessageName.WatchPlayerRounds]: Handler<
		WatchPlayerRoundsPayload,
		WatchDemoErrorPayload | undefined
	>;
	...
	[RendererClientMessageName.WatchPlayerAsSuspect]: Handler<
		...
		WatchDemoErrorPayload | undefined
	>;
	[RendererClientMessageName.ExportMatchChatMessages]: Handler<
		ExportChatMessagesPayload,
		boolean
	>;
	[RendererClientMessageName.ExportMatchesChatMessages]: Handler<
		ExportMatchesChatMessagesPayload,
		boolean
	>;
	[RendererClientMessageName.WriteBase64File]: Handler<WriteBase64FilePayload>;
	[RendererClientMessageName.FetchPlayerStats]: Handler<
		FetchPlayerPayload,
		PlayerProfile
	>;
	...
	[RendererClientMessageName.FetchLastFaceitMatches]: Handler<
		string,
		FaceitMatch[]
	>;
	[RendererClientMessageName.AddFaceitAccount]: Handler<string, FaceitAccount>;
	[RendererClientMessageName.UpdateCurrentFaceitAccount]: Handler<
		string,
		FaceitAccount[]
	>;
	[RendererClientMessageName.DeleteFaceitAccount]: Handler<
		string,
		FaceitAccount[]
	>;
	[RendererClientMessageName.SearchEvent]: Handler<SearchPayload, SearchResult>;
	[RendererClientMessageName.SearchPlayers]: Handler<
		PlayersFilter,
		PlayerResult[]
	>;
	...
	[RendererClientMessageName.ImportDataFromV2Backup]: Handler<
		ImportV2BackupOptions,
		ImportV2BackupResult
	>;
	[RendererClientMessageName.FetchLast5EPlayMatches]: Handler<
		string,
		FiveEPlayMatch[]
	>;
	[RendererClientMessageName.Add5EPlayAccount]: Handler<
		string,
		FiveEPlayAccount
	>;
	[RendererClientMessageName.Delete5EPlayAccount]: Handler<
		string,
		FiveEPlayAccount[]
	>;
	[RendererClientMessageName.UpdateCurrent5EPlayAccount]: Handler<
		string,
		FiveEPlayAccount[]
	>;
	[RendererClientMessageName.FetchLastRenownMatches]: Handler<
		string,
		RenownMatch[]
	>;
	[RendererClientMessageName.AddRenownAccount]: Handler<string, RenownAccount>;
	[RendererClientMessageName.DeleteRenownAccount]: Handler<
		string,
		RenownAccount[]
	>;
	[RendererClientMessageName.UpdateCurrentRenownAccount]: Handler<
		string,
		RenownAccount[]
	>;
	[RendererClientMessageName.CapturePlayerView]: Handler<
		Game,
		CapturePlayerViewPayload
	>;
}
...
export const rendererHandlers: RendererMessageHandlers = {
	[RendererClientMessageName.InitializeApplication]:
		initializeApplicationHandler,
	[RendererClientMessageName.IsCs2ConnectedToServer]:
		isCs2ConnectedToServerHandler,
	...
	[RendererClientMessageName.FetchMatchHeatmapPoints]:
		fetchMatchHeatmapPointsHandler,
	[RendererClientMessageName.FetchTeamHeatmapPoints]:
		fetchTeamHeatmapPointsHandler,
	[RendererClientMessageName.FetchPlayerHeatmapPoints]:
		fetchPlayerHeatmapPointsHandler,
	[RendererClientMessageName.Fetch2DViewerData]: fetch2DViewerDataHandler,
	[RendererClientMessageName.FetchMatchVoiceActivity]:
		fetchMatchVoiceActivityHandler,
	...
	[RendererClientMessageName.RemoveDemosFromAnalyses]:
		removeDemosFromAnalysesHandler,
	[RendererClientMessageName.GenerateMatchPositions]:
		generateMatchPositionsHandler,
	[RendererClientMessageName.RenameDemo]: renameDemoHandler,
	[RendererClientMessageName.DeleteMatches]: deleteMatchesHandler,
	[RendererClientMessageName.DeleteIgnoredSteamAccount]:
		deleteIgnoredSteamAccountHandler,
	[RendererClientMessageName.FetchLastValveMatches]:
		fetchLastValveMatchesHandler,
	...
	[RendererClientMessageName.AddDownloadFromShareCode]:
		addDownloadFromShareCodeHandler,
	...
	[RendererClientMessageName.ExportDemoPlayersVoice]:
		exportDemoPlayersVoiceHandler,
	[RendererClientMessageName.UpdateMatchesType]: updateMatchesTypeHandler,
	[RendererClientMessageName.UpdateMatchesTeamNames]:
		updateMatchesTeamNamesHandler,
	[RendererClientMessageName.UpdateSteamAccountName]:
		updateSteamAccountNameHandler,
	...
	[RendererClientMessageName.AddIgnoredSteamAccount]:
		addIgnoredSteamAccountHandler,
	...
	[RendererClientMessageName.DisconnectDatabase]:
	...
	[RendererClientMessageName.UpdateMatchDemoLocation]:
		updateMatchDemoLocationHandler,
	[RendererClientMessageName.InstallHlae]: installHlaeHandler,
	[RendererClientMessageName.UpdateHlae]: updateHlaeHandler,
	[RendererClientMessageName.EnableHlaeCustomLocation]:
		enableHlaeCustomLocationHandler,
	[RendererClientMessageName.DisableHlaeCustomLocation]:
		disableHlaeCustomLocationHandler,
	...
	[RendererClientMessageName.EnableFfmpegCustomLocation]:
		enableFfmpegCustomLocationHandler,
	[RendererClientMessageName.DisableFfmpegCustomLocation]:
		disableFfmpegCustomLocationHandler,
	[RendererClientMessageName.RemoveVideosFromQueue]:
		removeVideosFromQueueHandler,
	[RendererClientMessageName.FetchMatchFlashbangMatrixRows]:
		fetchMatchFlashbangMatrixRowsHandler,
	[RendererClientMessageName.FetchMatchDuelsMatrixRows]:
		fetchMatchDuelsMatrixRowsHandler,
	[RendererClientMessageName.FetchMatchGrenadesThrow]:
		fetchMatchGrenadesThrowHandler,
	...
	[RendererClientMessageName.WatchPlayerHighlights]:
		watchPlayerHighlightsHandler,
	...
	[RendererClientMessageName.ExportMatchChatMessages]:
		exportMatchChatMessagesHandler,
	[RendererClientMessageName.ExportMatchesChatMessages]:
		exportMatchesChatMessagesHandler,
	...
	[RendererClientMessageName.FetchLastFaceitMatches]:
		fetchLastFaceitMatchesHandler,
	[RendererClientMessageName.AddFaceitAccount]: addFaceitAccountHandler,
	[RendererClientMessageName.UpdateCurrentFaceitAccount]:
		updateCurrentFaceitAccountHandler,
	...
	[RendererClientMessageName.DeleteDemosFromDatabase]:
		deleteDemosFromDatabaseHandler,
	[RendererClientMessageName.ImportDataFromV2Backup]:
		importDataFromV2BackupHandler,
	[RendererClientMessageName.FetchLast5EPlayMatches]:
		fetchLast5EPlayMatchesHandler,
	...
	[RendererClientMessageName.UpdateCurrent5EPlayAccount]:
		updateCurrent5EPlayAccountHandler,
	[RendererClientMessageName.FetchLastRenownMatches]:
		fetchLastRenownMatchesHandler,
	...
	[RendererClientMessageName.UpdateCurrentRenownAccount]:
		updateCurrentRenownAccountHandler,
