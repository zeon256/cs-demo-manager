...
export const RendererClientMessageName = {
	...
	FetchLastRenownMatches: "fetch-last-renown-matches",
	AddRenownAccount: "add-renown-account",
	DeleteRenownAccount: "delete-renown-account",
	UpdateCurrentRenownAccount: "update-current-renown-account",
	...
	FetchMatchVoiceActivity: "fetch-match-voice-activity",
} as const;

export type RendererClientMessageName =
	(typeof RendererClientMessageName)[keyof typeof RendererClientMessageName];
