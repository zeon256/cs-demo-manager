...
export const replaceSequences = createAction<{
	demoFilePath: string;
	sequences: Sequence[];
}>("match/video/sequences/replace");
export const deleteSequences = createAction<{ demoFilePath: string }>(
	"match/video/sequences/deleteAll",
);
export const generatePlayersKillsSequences =
	createAction<GeneratePlayersEventPayload>(
		"match/video/sequences/generatePlayersKills",
	);
export const generatePlayersDeathsSequences =
	createAction<GeneratePlayersEventPayload>(
...
export const generatePlayersRoundsWithTeammatesSequences = createAction<{
	steamIds: string[];
	match: Match;
	startSecondsBeforeEvent: number;
	endSecondsAfterEvent: number;
